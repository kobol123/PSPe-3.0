...
public  class NativeActivity extends Activity implements  SensorEventListener{
	...
	private static final int MY_PERMISSIONS_REQUEST_BODY_SENSORS = 102 ;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.MANUFACTURER == "OUYA") {
			...
			mGLSurfaceView.willNotCacheDrawing();
        	//mGLSurfaceView.setEGLConfigChooser(new NativeEGLConfigChooser());
        }
		mGLSurfaceView.getHolder().setFormat(PixelFormat.OPAQUE);

		mGLSurfaceView.willNotCacheDrawing();
		mGLSurfaceView.getHolder().setFixedSize(800,600);
		mGLSurfaceView.getHolder().setType(SurfaceHolder.SURFACE_TYPE_HARDWARE);
...
//	        NativeApp.accelerometer(x, y, z , 0);
//        	//}
//	        
